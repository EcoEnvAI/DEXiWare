...
* */
async function doBottomUpAnalysis(root_only,req,res){
  try{
    ...
    */
    ...
    processGrammarEntry = libHandler.prepareExecution(taskConfig.getModel("_",req.params.model), "evaluate_transitional", "java", response );
...
async function doTopDownAnalysis(req,res){
  ...
  * */
  ...
  //Process assessment evaluation
  processGrammarEntry = libHandler.prepareExecution(taskConfig.getModel("_",req.params.model), "generate", "java", response );
